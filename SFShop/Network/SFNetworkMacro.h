...
#define K_articles_evaluate_domain(url) [NSString stringWithFormat:@"%@/h5/articles/%@/evaluate/list",Host,url]
...
#define K_refundApply_domain(url) [NSString stringWithFormat:@"%@/h5/orderapply/%@",Host,url]
#define K_refund_domain(url) [NSString stringWithFormat:@"%@/h5/refund/%@",Host,url]
