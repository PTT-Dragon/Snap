...
- (void)drawShadow
{
    ...
    _bgView.layer.shadowRadius = 3;//阴影圆角
     ...
     */
    //阴影路径
    _bgView.layer.shadowPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, App_Frame_Width-32, _bgView.bounds.size.height) cornerRadius:_bgView.layer.cornerRadius].CGPath;
}
