...
- (void)setContent:(OrderModel *)model
{
    ...
    _btn2.hidden = [model.state isEqualToString:@"F"] || [model.state isEqualToString:@"G"] || ([model.isAfterSales isEqualToString:@"Y"] && [model.state isEqualToString:@"B"]) || [model.state isEqualToString:@"E"];
