...
- (void)setContent:(OrderModel *)model
{
    ...
    _btn1.backgroundColor = ([model.state isEqualToString:@"A"] || [model.state isEqualToString:@"C"] || [model.state isEqualToString:@"B"] || [model.state isEqualToString:@"E"] || [model.state isEqualToString:@"F"]) ? RGBColorFrom16(0xff1659): [UIColor whiteColor];
    [_btn1 setTitleColor:([model.state isEqualToString:@"A"] || [model.state isEqualToString:@"C"] || [model.state isEqualToString:@"B"] || [model.state isEqualToString:@"E"] || [model.state isEqualToString:@"F"]) ? [UIColor whiteColor]: RGBColorFrom16(0xff1659) forState:0];
