...
- (void)requestEvaluationsList
{
    ...
    _pageIndex = 1;
    MPWeakSelf(self)
    [SFNetworkManager get:SFNet.offer.evaluationList parameters:@{@"offerId":@(_offerId),@"pageIndex":@(1),@"pageSize":@(2),@"evaluationType":_evaluationType,@"labelId":_labelId?_labelId:@""} success:^(id  _Nullable response) {
