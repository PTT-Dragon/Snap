...
#define JKRGBColorFrom16(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]

#pragma mark 5、存值、取值、存BOOL值
/** 5、存值、取值、存BOOL值 */
//存值(可变的值不可以存)
...
#pragma mark 14.JKOCProjectTool.bundle 路径的查找
/**
...
#pragma mark 17、强制让App直接退出（非闪退，非崩溃）
/**
 17、强制让App直接退出（非闪退，非崩溃）
 */
...
#pragma mark 18、调用代码使APP进入后台，达到点击Home键的效果
/**
 18、调用代码使APP进入后台，达到点击Home键的效果
 */
